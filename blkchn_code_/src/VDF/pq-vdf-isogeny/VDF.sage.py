...
_sage_const_32 = Integer(32); _sage_const_256 = Integer(256); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_12 = Integer(12); _sage_const_13 = Integer(13); _sage_const_14 = Integer(14); _sage_const_15 = Integer(15); _sage_const_16 = Integer(16); _sage_const_17 = Integer(17); _sage_const_18 = Integer(18); _sage_const_19 = Integer(19); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_24 = Integer(24)
...
if args.leader == True:
    ...
    str_result = ""
    for point in result:
        lpoint = point[_sage_const_1 :-_sage_const_1 ].split(" : ")[:-_sage_const_1 ]
        for coord in lpoint:
            lint = coord.split("*i + ")
            str_result += lint[_sage_const_0 ] + "\n" + lint[_sage_const_1 ] + "\n"
